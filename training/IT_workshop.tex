...
\author{L.~Whiteway, E.~Edmondson, L.~Lucie-Smith}
...
\begin{frame}{Git workstyles}
  \begin{itemize}
    ...
    \item On larger projects you begin by copying the official repository to a new `forked' copy (also on the Internet). You can then develop (as above) in this fork. Later you can ask for your forked copy be merged back into the official copy (`pull request'). This gives the offical owners more control over changes.
  \end{itemize}
\end{frame}
