...
\begin{frame}{What will you learn?}
  \begin{itemize}
    ...
    \item{20 October:}
    \begin{itemize}
    \item An intro to commonly used programs (LaTeX, DS9, IRAF)
...
\begin{frame}[fragile]{Accessing machines remotely}
  ...
  \end{block}
  \begin{block}{Step 1 - login to zuserver}
     \texttt{ssh -YC username@zuserver.star.ucl.ac.uk}
  \end{block}
  \begin{block}{Step 2 - login to other machines from zuserver}  
    \texttt{ssh -YC username@splinter.star.ucl.ac.uk}
  \end{block}
\end{frame}
