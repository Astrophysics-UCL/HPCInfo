...
\begin{frame}{HPC: How to parallelize}
  ...
  \begin{itemize}
    ...
    \item No fast way for the various running copies to talk to each other during processing. Therefore this method is useful only when the problem can be divided into independent chunks. Such problems are called `embarassingly parallel'.
  \end{itemize}
\end{frame}
...
\begin{frame}{HPC: Using \emph{Ganglia}}
	...
	\begin{itemize}
		\item is tool for analysing \texttt{splinter}
