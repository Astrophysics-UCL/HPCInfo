...
\definecolor{light-green}{cmyk}{0.1,0,0.1,0}
...
\begin{frame}{Remote connections}
  \begin{block}{How to connect to a shared machine}
    \begin{itemize}
      \item Windows PC: use PuTTY (or MobaXterm, which uses PuTTY);
...
\begin{frame}{Visibility}
  \begin{block}{}
      \begin{itemize}
    \item If you are not on the UCL network then to connect to Astro or UCL HPC servers you will need to set up a Virtual Private Environment. For details see \url{https://www.ucl.ac.uk/isd/services/get-connected/ucl-virtual-private-network-vpn}.
    \item An alternative is to logon to \texttt{zuserver1} and from there logon to the server.
      \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}{Linux: Directory structure}
  \begin{itemize}
    ...
    \item{Sample file name: \texttt{/home/ucapwhi/foo.txt}}
