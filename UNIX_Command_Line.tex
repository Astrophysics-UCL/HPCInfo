...
\begin{frame}{Unix}
  \begin{itemize}
    ...
    \item Unix is multi-tasking and multi-user, with a modular design: the operating system provides various single-purpose tools that may be linked together for more compilcated tasks.
...
\begin{itemize}
\item \server{splinter} and \server{hypatia} are \text{high performance computing} (HPC) clusters.
